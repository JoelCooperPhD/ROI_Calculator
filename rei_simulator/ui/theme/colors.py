"""
Color palette for REI Simulator UI.

Dark theme matching TheLogger's design philosophy:
...
class Colors:
    ...
    BG_SECTION = "#2b2b2b"       # Section/grouped area backgrounds (matches BG_DARK)
    ...
    STATUS_WARNING = "#f39c12"   # Orange - warnings
    STATUS_SUCCESS = "#2ecc71"   # Green - success
    STATUS_ERROR = "#e74c3c"     # Red - error

    # Button colors
    BTN_ACTIVE_BG = "#2ecc71"    # Green for active/calculate buttons
    ...
    BTN_DEFAULT_BG = "#404040"   # Dark gray default button
